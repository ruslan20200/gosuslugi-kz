...
export const POSITIONS = {
  ...
  citizenship: { top: 99, left: 110, fontSize: 12, fontWeight: 460 }, // ГРАЖДАНСТВО
  dates: { top: 125, left: 110, fontSize: 12, fontWeight: 460 }, // ДАТА ВЫДАЧИ - СРОК
  issuingAuthority: { top: 125, left: 330, fontSize: 12, fontWeight: 460 }, // ОРГАН ВЫДАЧИ (МВД РК)
